...
import 'package:adawat_customer_app/custom_widgets/custom_radio_button.dart';
import 'package:adawat_customer_app/screens/language/language_viewmodel.dart';
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      children: [
                        const SearchField(),
                        Column(
                            children: viewModel.languageController.optionsLocales.entries.map((item) {
                        return LanguageTile(item: item);
                      }).toList()),])
                    ),
                  ),
                ),
